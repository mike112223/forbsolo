...
MODEL_CFGS = {
    'resnet18': {
        'block': BasicBlock,
        'layer': [2, 2, 2, 2],
        'weights_url': MODELS_URLS['resnet18'],
    },
    'resnet34': {
        'block': BasicBlock,
        'layer': [3, 4, 6, 3],
        'weights_url': MODELS_URLS['resnet50'],
    },
    'resnet50': {
        'block': Bottleneck,
        'layer': [3, 4, 6, 3],
    ...
    'resnet101': {
        'block': Bottleneck,
        'layer': [3, 4, 23, 3],
        'weights_url': MODELS_URLS['resnet101'],
    },
    'resnet152': {
        'block': Bottleneck,
        'layer': [3, 8, 36, 3],
    ...
    'resnext50_32x4d': {
        'block': Bottleneck,
        'layer': [3, 4, 6, 3],
        'weights_url': MODELS_URLS['resnext50_32x4d'],
        'groups': 32,
        'width_per_group': 4,
    },
    'resnext101_32x8d': {
        'block': Bottleneck,
        'layer': [3, 4, 23, 3],
        'weights_url': MODELS_URLS['resnext101_32x8d'],
        'groups': 32,
        'width_per_group': 8,
    },
}
